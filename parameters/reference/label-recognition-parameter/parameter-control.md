...
title: Dynamsoft Barcode Reader Parameter Reference for LabelRecognitionParameter Object - Image Process Control Parameters
description: This page shows Dynamsoft Barcode Reader Parameter Reference for LabelRecognitionParameter Object - Image Process Control Parameters.
keywords: DeblurLevel, Pages, PDFRasterDPI, PDFReadingMode, ScaleDownThreshold, LabelRecognitionParameter, image process control parameters, parameter reference, parameter
...
# LabelRecognitionParameter Object - Image Process Control Parameters
 ...
 | [`LabelRecognitionParameter.Pages`](#pages) | Sets the specific pages or the range of pages of a file (.tiff or .pdf) for barcode searching. |
 | [`LabelRecognitionParameter.PDFRasterDPI`](#pdfrasterdpi) | Sets the output image resolution. |
 | [`LabelRecognitionParameter.PDFReadingMode`](#pdfreadingmode) | Sets the way to detect barcodes from a PDF file when using the DecodeFile method. |
 ...
 | [`LabelRecognitionParameter.ScaleDownThreshold`](#scaledownthreshold) | Sets the threshold for the image shrinking. |
...
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| LabelRecognitionParameter | DeblurLevel | *int* | [0, 9] | 9 |
...
| Json Object |	Json Parameter Name | Value Type | Value Range | Default Value |
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| LabelRecognitionParameter | PDFRasterDPI | *int * | [100, 600] | 300 |
...
| Json Object |	Json Parameter Name | Value Type | Value Range | Default Value |
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| LabelRecognitionParameter | PDFReadingMode | *string* | Any one of the [`PDFReadingMode` Enumeration]({{ site.enumerations }}result-enums.html#pdfreadingmode) items. | "PDFRM_AUTO" |
...
| Json Object |	Json Parameter Name | Value Type | Value Range | Default Value |
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| LabelRecognitionParameter | ScaleDownThreshold | *int* | [512, 0x7fffffff] | 2300 |
