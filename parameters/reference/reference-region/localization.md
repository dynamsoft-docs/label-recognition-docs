...
| Json Object |	Json Parameter Name | Value Type | Value Range | Default Value |
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| Localization | BarcodeFormatIds | *string Array* | An array item can be any one of the [`DLRBarcodeFormat` Enumeration]({{ site.enumerations }}format-enums.html#dlrbarcodeformat) items | "DLR_BF_ALL" |
...
| Json Object |	Json Parameter Name | Value Type | Value Range | Default Value |
| ----------- | ------------------- | ---------- | ----------- | ------------- |
| Localization | BarcodeFormatIds_2 | *string Array* | An array item can be any one of the [`DLRBarcodeFormat_2` Enumeration]({{ site.enumerations }}format-enums.html#dlrbarcodeformat_2) items | "DLR_BF2_NULL" |
