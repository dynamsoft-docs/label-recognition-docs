...
|----------------------|-------------|
  ...
  | [`appendSettingsFromFile`](#appendsettingsfromstring) | Appends LabelRecognitionParameter settings from a file to the SDK object. |
...
Append new templates strings from a file to the current label recognition instance.
...
#### Parameters
`filePath` A file path of the file that illustrate the content of the settings.   
