...
title: Dynamsoft Label Recoginizer C/C++ SDK - Release Notes 1.x
...
- Added a new property [`products`]({{ site.c-cplusplus-api-reference }}structs/dm-lts-connection-parameters.html#products) to `DMLTSConnectionParameters`.
