...
title: Dynamsoft Label Recognizer .Net SDK - Release Notes 1.x
...
- Added a new property [`PageNumber`]({{ site.dotnet_api }}dlr-result.html#pagenumber) to `DLR_Result` to identify the page on which the result is located.
